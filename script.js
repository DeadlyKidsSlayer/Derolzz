...
tombolSelesaikan.addEventListener("click", () => {
  ...
  // Hentikan pemutaran backsound
  backsound.pause();
  backsound.currentTime = 0; // Reset waktu audio ke awal
});
...
document.getElementById("mulai-ujian").addEventListener("click", function () {
  ...
  // Hentikan backsound saat ujian dimulai
  backsound.pause();
...
// Mulai backsound otomatis saat halaman dimuat
backsound.play();